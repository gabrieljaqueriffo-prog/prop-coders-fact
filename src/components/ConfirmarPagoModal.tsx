  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 p-4" onClick={onClose}>
      ...
      >
        ...
        <label className="mb-1 block text-xs font-semibold uppercase text-gray-500">Fecha de pago</label>
        <input
          type="date"
          value={fechaPago}
        ...
        <label className="mb-1 block text-xs font-semibold uppercase text-gray-500">Número de transacción</label>
        <input
        ...
        <label className="mb-1 block text-xs font-semibold uppercase text-gray-500">Comprobante (imagen o PDF)</label>
        <input
          type="file"
        ...
        />
        {comprobanteNombre && <p className="mb-3 text-xs text-gray-500">Archivo: {comprobanteNombre}</p>}
