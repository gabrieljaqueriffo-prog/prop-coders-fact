      ...
      >
        ...
        <div className="grid flex-1 grid-cols-1 gap-6 overflow-y-auto px-6 py-5 lg:grid-cols-2">
          <div className="space-y-4">
            ...
            <div className="ml-auto w-full max-w-xs space-y-1 rounded border border-slate-200 p-3 text-sm">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div>
                      <p className="text-xs text-slate-400">
                        Vencimiento {esCesionAutoritativa ? "(cesión)" : "estimado"}
                      </p>
            ...
            <div className="rounded border border-slate-200 p-3">
              ...
              {gestion?.estado === "pagado" && (gestion.comprobante || gestion.numeroTransaccion) && (
                <div className="mb-3 rounded border border-green-200 bg-green-50 p-2 text-xs text-green-800">
                  ...
                  {gestion.comprobante && (
                    <a
                      href={gestion.comprobante}
                      download={gestion.comprobanteNombre}
